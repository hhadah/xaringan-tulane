...
These are available in the assets folder of the GitHub code repository [`r icons::fontawesome("github")` `hhadah/xaringan-tulane`](http://github.com/hhadah/xaringan-tulane/assets)

To make things easy to get started, I recommend downloading a copy of the `xaringan-tulane` repo [`r icons::fontawesome("file-archive")`](https://github.com/hhadah/xaringan-tulane/archive/master.zip) and make changes to the template. 
...
<a href="https://hhadah.github.io/">
.white[`r icons::fontawesome("link")` https://hhadah.github.io/]
</a>
...
infile = list.files(path = "/Users/hhadah/Documents/GiT/Tulane_temp", pattern = 'index.html')
